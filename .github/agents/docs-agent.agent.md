...
tools: [read/readFile, edit/editFiles, edit/createFile, search/changes, search/codebase, search/fileSearch, search/listDirectory, search/textSearch, search/usages, web/fetch, azure-mcp/search]
---
...
2. Write user guides for the deal health dashboard
